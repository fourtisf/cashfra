...
- The *Shill team* chip shows the slice of the money **received** that the team is credited with, which is deliberately **not** Money in — the difference is what ALFA brought himself. Its second line names the leader, or says `N credited, none landed` when a credited listing has not been paid, or `nobody credited`. A bare `$0.00` with nothing under it is the bug that reading was written to prevent.
